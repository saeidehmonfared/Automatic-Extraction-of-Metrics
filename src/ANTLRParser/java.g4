...
typeName
	:	Identifier              # t0
	|	packageOrTypeName '.' Identifier # T01
	;

packageOrTypeName
	:	Identifier                  # t1
	|	packageOrTypeName '.' Identifier  # t2
	;
...
fieldDeclaration
	:	 unannType variableDeclaratorList ';' # fielddeclaration1
	|      fieldModifier* unannType variableDeclaratorList ';' # fielddeclaration2
	;
...
methodDeclaration
 ...
 methodtest
    ...
    ;
methodHeader
	:	 methodtest2 methodDeclarator throws_?
	|	typeParameters annotation* result methodDeclarator throws_?
	;
	methodtest2
	: methodModifier* result
	;
